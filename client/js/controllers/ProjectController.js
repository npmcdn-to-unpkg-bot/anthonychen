angular
  ...
  .controller('ProjectController', ['$scope', '$state', '$location', 'ProjectEntry', '$sanitize', function($scope, $state, $location, $ProjectEntry, $sanitize) {
	  ...
	  {type: "Software", published: true, ctime: new Date("2016-02-22"), title: "Microsoft Excel + Choropleth", 
	   content: "<p class='lead'>Excel for visualizing registration data</p><img class='img-responsive' src='/media/projects/software/choropleth.png'><p>This is a visualization I created using an <a href='http://www.clearlyandsimply.com/clearly_and_simply/2012/09/faster-choropleth-maps-with-microsoft-excel.html'>open-source excel worksheet</a> that I found through google.  I was interested in creating a time-based visualization which showed user registration growth in a geographical manner by county.  The data here has to do with education and education tends to fall into counties and districts so it was a bit different from the typical city/state-level visualizations that are more readily available. </p><p>I think that the worksheet was well made and easy to understand.  If I had to do it again, I would have created something using a D3-based choropleth visualization instead but this was the shortest path to getting what I needed.</p>"},
	  ...
	  {type: "CNC Routing", published: true, ctime: new Date("2016-02-19"), title: "Hello Kitty in Cast Acrylic", 
	   content: "<p class='lead'>Hold on, PreciseBits!.</p><img class='img-responsive' src='/media/projects/cncrouting/cnc.hellokitty.jpg'><p>This Hello Kitty face was one of the first things I ever cut on my CNC machine.  As with many things, going from a software-based design into something tangible is often fraught with problems.  I was able to learn a lot from this experience.</p><p>In my opinion, the most important part of the CNC routing process is figuring out how to hold the material down that you're cutting.  If you can't securely hold what you're cutting, the material may shift which can cause small or large deviations from the design.</p><p>Up to the point of cutting this part, I had always been machining some sort of wood-based material like basic plywood.  With plywood, you can simply screw down the piece to your spoilboard and it pretty much won't go anywhere.  With acrylic, you can do the same, but you want to drill a hole and then screw it down.  However, not only do you want to secure the outside of what you're cutting, you should secure the actual thing you're cutting too.  Putting a screw hole here was out of the question.</p><p>Double-sided tape to the rescue!  Acrylic often comes with a protective masking sheet so using double sided tape permitted a good way to hold down the part being machined.  You'll want to be careful and not cut past the protective sheet as that could result in residue on your bit.  It also helps to plan the toolpaths so that you know where your parts will be to secure.</p>"}
      ];
